...
public class NeurophProjectTemplateWizardIteratorPerceptron implements WizardDescriptor./*Progress*/InstantiatingIterator {
   ...
   private int index;
    ...
    public NeurophProjectTemplateWizardIteratorPerceptron() {
    }

    public static NeurophProjectTemplateWizardIteratorPerceptron createIterator() {
        return new NeurophProjectTemplateWizardIteratorPerceptron();
    }

       private WizardDescriptor.Panel[] createPanels() {
        return new WizardDescriptor.Panel[]{
                    new NeurophProjectTemplateWizardPanelPerceptron(),};
    }

    private String[] createSteps() {
        return new String[]{
                    NbBundle.getMessage(NeurophProjectTemplateWizardIteratorPerceptron.class, "LBL_CreateProjectStep")
                };
    }
