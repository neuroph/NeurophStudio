...
public class NeurophProjectTemplateWizardIteratorMultiLayerPerceptron implements WizardDescriptor./*Progress*/InstantiatingIterator {
   ...
   private int index;
    ...
    public NeurophProjectTemplateWizardIteratorMultiLayerPerceptron() {
    }

    public static NeurophProjectTemplateWizardIteratorMultiLayerPerceptron createIterator() {
        return new NeurophProjectTemplateWizardIteratorMultiLayerPerceptron();
    }

       private WizardDescriptor.Panel[] createPanels() {
        return new WizardDescriptor.Panel[]{
                    new NeurophProjectTemplateWizardPanelMultiLayerPerceptron(),};
    }

    private String[] createSteps() {
        return new String[]{
                    NbBundle.getMessage(NeurophProjectTemplateWizardIteratorMultiLayerPerceptron.class, "LBL_CreateProjectStep")
                };
    }
