...
public class NeurophProjectRootNode extends FilterNode {
    ...
    private final static Image ICON = ImageUtilities.loadImage("org/neuroph/netbeans/wizards/project/templates/neurophProjectIcon.gif");
...
//    this.project.addChangeListener(this);
    ...
    public Image getIcon(int type) {
        ...
        return ImageUtilities.mergeImages(original, ICON, 0, 0);
    }
